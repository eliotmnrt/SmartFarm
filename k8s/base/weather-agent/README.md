...
- `k8s/base/weather-agent/service.yaml` - ClusterIP service on port `8080`
...
```bash
kubectl port-forward svc/weather-agent 8080:8080
curl -X POST http://localhost:8080/weather -H 'Content-Type: application/json' \
